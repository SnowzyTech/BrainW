    ...
    >
       <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb:[6rem]">
            ...
            <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">Unlease 
            the power of &nbsp;AI&nbsp; within Brainwave. 
                Upgrade your productiviity with brainwave the open AI chat app.
            </p>
            ...
            <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
                <div className="relative bg-n-8 rounded-[1rem]">
                    ...
                    <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden 
                     md:aspect-ratio-[688/490] lg:aspect-[1024/490]">
                        <img 
                         src={robot} alt="AI" 
        ...
        <CompanyLogos className="mt-20 hidden relative lg:block z-10" />
       </div>
