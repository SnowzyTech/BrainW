     ...
     <Section id="how-to-use">
        <div className="container">
            <Heading title="Generative AI made for creators"
             text="BrainW unlocks the Potential of AI-powered applications" />


            <div className="relative">
                <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border
                  border-n-1/10 overflow-hidden lg:p-20 xl:h-[46rem] rounded-3xl">
                    ...
                    <div className="relative ml-auto z-1 max-w-[17rem]">
                        ...
                        <p className="body-2 mb-[3rem] text-n-3">BrainW unlocks the potentil of AI-Powered 
                         applications
                        </p>
                        <ul className="body-2">
                    ...
                    <Generating className="absolute left-4 right-4 bottom-4 border
                     border-n-1/10 lg:left-1/2 lg-right-auto lg:bottom-8 lg:-translate-x-1/2" />
                </div>

                <div className="relative z-1 grid gap-5 lg:grid-cols-2">
                    <div className="relative min-h-[39rem] border
